...
<html>
    <head>
        ...
        <script type="text/javascript"  src="newfleet.js"></script>
    </head>
    <body>
        <header>
...
<div class = "dashboard">
    <nav class="left">
        ...
        <a href='newfleetcustomer.php'><button class="btn"><i class='fa fa-dashboard'>  DASHBOARD</i></button></a>
               ...
               <ul id="list">
                   <li><a href="#"><u>Available Car Brands</u></a></li>
    ...
    <div class="returned"></div>
        <?php
                $Customer_ID=$row['Customer_ID'];
                $sql="SELECT * from car c, customer t ,requisition r
                      WHERE c.Car_ID = r.Car_ID AND r.Customer_ID = t.Customer_ID AND t.Customer_ID = $Customer_ID";
                    ...
                    while ($row = mysqli_fetch_assoc($result))
                    {
                       /* $row=mysqli_fetch_assoc($result);*/
                        ...
                        <div class='txtbox'>
                            ...
                            <button type='button' class='cancel'>Edit Requisition</button>
